nom1 = str(input('Digite o seu nome e idade usando uma,: '))
nom2 = str(input('Digite o seu nome e idade usando uma,: '))
nom3 = str(input('Digite o seu nome e idade usando uma,: '))
